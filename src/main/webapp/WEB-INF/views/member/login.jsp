...
<!-- SLIDER -->
<section class="slider d-flex" style="background-image: url('/resources/common/photo/background.jpg');"> <!-- background 아니면 4 -->
    <div class="container">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-10">
						  	<form action="/member/login" method="post">
						    	...
						    	<div class="mb-3 mt-3 regiTag">		
									<p>계정이 없다면 <a href="/member/register">여기</a>를 클릭해주세요!</p>
								</div>
							</form>
                        </div>
                    </div>

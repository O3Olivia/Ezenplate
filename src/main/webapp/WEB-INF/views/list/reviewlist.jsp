...
<div class="mt-3 ml-5 d-inline-flex justify-content-end">
 <ul class="nav mt-3"  >	
    ...
    <li class="nav-item">
      <a class="nav-link disabled" href="../list/holic?pageNo=${pgn.pgvo.pageNo }&qty=${pgn.pgvo.qty}">Holic<span class="badge bg-primary rounded-pill ">${pgn1.totalCount }</span></a>
    </li>
    <li class="nav-item">
...
<!-- <table class="table table-striped" id="cmtZone"></table> -->
  ...
  <div class="text-center" style="visibility: hidden;">
	...
	<script src="/resources/js/list.listmore.js">
	</script>
